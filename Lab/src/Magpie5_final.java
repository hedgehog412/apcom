...
public class Magpie5_final
{
	...
	public String transform2nd_FormStatement(String question, String subject, String verb, String subjectComplement)
	{
		...
		if(check == false){
				...
				if( typeOfVerb == 1 )
				{
					...
					verbs_2ndPerception_Output.print(verb + " ");
					verbs_2ndPerception_Output.print(newVerb + " ");
				...
				if( typeOfVerb == 2 )
				{
					...
					verbs_2ndPerception2_Output.print(verb + " ");
					verbs_2ndPerception2_Output.print(newVerb + " ");
				...
				else if( typeOfVerb == 3 )
				{
					...
					verbs_2ndState_Output.print(verb + " ");
					verbs_2ndState_Output.print(newVerb + " ");
				...
				else if( typeOfVerb == 4 )
				{
					...
					verbs_2ndChange_Output.print(verb + " ");
					verbs_2ndChange_Output.print(newVerb + " ");
	...
	public String transform4th_FormStatement(String subject, String verb, String directObject, String indirectObject)
	{
		...
		case 0: // past
			...
			if (whichResponse == 0)
				newStatement = "Did you like " + directObject + "?";
	...
	{
		if(findKeyword(statement, a, 0) >= 0)
			statement = statement.substring(0, findKeyword(statement, a, 0)) + b + statement.substring(findKeyword(statement, a, 0) + a.length());
		else if(findKeyword(statement, b, 0) >= 0)
			statement = statement.substring(0, findKeyword(statement, b, 0)) + a + statement.substring(findKeyword(statement, b, 0) + b.length());
	...
	private String Check_AddToFile(String verb)
	{
		...
		while(verbs_Input.hasMoreTokens()){
			...
			if(findKeyword(newLine, verb, 0) == 0){
				...
				int i = 0;
				for(i = verb.length() + 1 ; i < newLineChar. length ; i++)
					  newVerb += newLineChar[i];
